...
export default function YeniIhaleTeklif() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('İhale/Teklif eklenirken hata oluştu:', error);
      alert('İhale/Teklif eklenirken bir hata oluştu');
    } finally {
      setLoading(false);
    }
  };

  // Input ve select elementlerinin ortak class'ını güncelleyelim
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">Yeni İhale/Teklif Ekle</h1>
      </div>
